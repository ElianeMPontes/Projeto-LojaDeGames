...
public class ProdutosController {
	...
	@Autowired
	private ProdutosRepository produtosRepository; // instancia de classe no spring
	...
	public ResponseEntity<List<Produtos>> getAll() {
		return ResponseEntity.ok(produtosRepository.findAll());// busca a lista de postagens
	}
